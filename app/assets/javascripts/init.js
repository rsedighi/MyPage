	...
	var _settings = {
		...
		// skel
			skel: {
				reset: 'full',
				breakpoints: {
					'max': { range: '*', href: 'assets/style.css', containers: 1440 },
					...
					'narrower': { range: '-1000', href: 'assets/style-narrower.css', containers: '95%', lockViewport: true },
					'mobile': { range: '-640', href: 'assets/style-mobile.css', grid: { gutters: 20 } },
